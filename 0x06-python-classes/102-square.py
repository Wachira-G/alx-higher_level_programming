...
class Square:
    ...
    def __eq__(self, other):
        ...
        Args:
            other: Another instance of MyClass.
    ...
    def __ge__(self, other):
        """Checks if the area of self is greater than
        ...
        Returns:
            bool: True if the area of self is greater than
    ...
    def __le__(self, other):
        """Checks if the area of self is less than
          or equal to the area of other.
